...
public class CfdpEntitySegmenterExceptionTest {
    ...
    @Test
    public void testSegmenterExceptionOnQuery() throws Exception {
        ...
        try {
            // Add problematic segmenter
            e1.addSegmentationStrategy(new ICfdpSegmentationStrategy() {
                @Override
                public boolean support(Mib mib, IVirtualFilestore filestore, String fullPath) {
                    return fullPath.endsWith("testfile_ack.bin");
                }
                ...
                public ICfdpFileSegmenter newSegmenter(Mib mib, IVirtualFilestore filestore, String fullPath, long destinationEntityId) throws FilestoreException {
                    throw new FilestoreException("Test exception to demonstrate the failure of the segmenter creation");
                }
            });
            ...
            PutRequest fduTxReq = PutRequest.build(2, path, destPath, true, null);
            e1.request(fduTxReq);

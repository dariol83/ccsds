...
class PromptPduBuilderTest {

    @Test
    public void testPromptPduBuilding() {
        PromptPduBuilder builder = new PromptPduBuilder()
        ...
        assertTrue(builder.isKeepAliveResponse());
        assertFalse(builder.isNakResponse());
    }
}
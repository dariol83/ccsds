    ...
    public void suspend() {
        handle(() -> {
            ...
            if(this.status == TransactionInnerStatus.RUNNING) {
                ...
                LOG.log(Level.WARNING, String.format("Transaction %d with remote entity %d: suspension requested by status is %s", getTransactionId(), getRemoteDestination().getRemoteEntityId(), this.status));
            }
        });
    }

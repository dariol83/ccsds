...
public class VirtualChannelSenderUserDataProcessor<T extends AbstractTransferFrame> extends TransformationStreamProcessor<byte[], T> {

	public VirtualChannelSenderUserDataProcessor(Function<byte[], Stream<T>> mapper, ExecutorService executor, boolean timely) {

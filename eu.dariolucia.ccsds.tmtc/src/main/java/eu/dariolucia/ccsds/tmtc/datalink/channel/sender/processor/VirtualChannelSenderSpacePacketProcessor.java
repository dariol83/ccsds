...
public class VirtualChannelSenderSpacePacketProcessor<T extends AbstractTransferFrame> extends TransformationStreamProcessor<SpacePacket, T> {

	public VirtualChannelSenderSpacePacketProcessor(Function<SpacePacket, Stream<T>> mapper, ExecutorService executor, boolean timely) {

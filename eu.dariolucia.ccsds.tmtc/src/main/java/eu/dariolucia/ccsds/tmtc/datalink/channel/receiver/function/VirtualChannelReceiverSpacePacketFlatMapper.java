...
public class VirtualChannelReceiverSpacePacketFlatMapper<T extends AbstractTransferFrame> implements Function<T, Stream<SpacePacket>> {
    ...
    public VirtualChannelReceiverSpacePacketFlatMapper(VirtualChannelReceiverSpacePacketMapper<T> mapper) {
        this.mapper = mapper;
    }

    @Override
    public Stream<SpacePacket> apply(T t) {
        List<SpacePacket> packets = this.mapper.apply(t);

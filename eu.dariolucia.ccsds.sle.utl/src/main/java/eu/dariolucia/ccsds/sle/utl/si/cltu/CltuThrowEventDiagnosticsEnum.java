...
public enum CltuThrowEventDiagnosticsEnum {
    ...
    CltuThrowEventDiagnosticsEnum(int code) {
        this.code = code;
    }
    ...
    public static CltuThrowEventDiagnosticsEnum getDiagnostics(int intValue) {
        for(CltuThrowEventDiagnosticsEnum b : CltuThrowEventDiagnosticsEnum.values()) {

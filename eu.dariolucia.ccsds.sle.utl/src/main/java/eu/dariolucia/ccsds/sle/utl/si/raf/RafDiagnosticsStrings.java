...
public class RafDiagnosticsStrings {

    private RafDiagnosticsStrings() {
        // Private constructor
    }
    ...
    public static String getStartDiagnostic(DiagnosticRafStart negativeResult) {
        if (negativeResult.getCommon() != null) {
            return "COMMON - " + getCommonDiagnostics(negativeResult.getCommon().intValue());
        } else {
    ...
    public static String getGetParameterDiagnostic(DiagnosticRafGet negativeResult) {
        if (negativeResult.getCommon() != null) {
            return "COMMON - " + getCommonDiagnostics(negativeResult.getCommon().intValue());
        } else {

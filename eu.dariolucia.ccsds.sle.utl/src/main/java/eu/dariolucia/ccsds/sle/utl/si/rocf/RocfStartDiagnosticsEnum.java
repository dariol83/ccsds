...
public enum RocfStartDiagnosticsEnum {
    ...
    RocfStartDiagnosticsEnum(int code) {
        this.code = code;
    }
    ...
    public static RocfStartDiagnosticsEnum getDiagnostics(int intValue) {
        for(RocfStartDiagnosticsEnum b : RocfStartDiagnosticsEnum.values()) {
